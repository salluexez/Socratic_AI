...
class _ProgressScreenState extends State<ProgressScreen> {
                        ...
                        children: [
                          ...
                          GridView.count(
                            ...
                            children: [
                              ...
                              StatCard(
                                title: 'Rounds',
                                value: '${sessions.fold<int>(0, (sum, s) => sum + (s.attemptCount ?? 0).toInt())}',
                                      ...
                                      Row(
                                        ...
                                        children: [
                                          ...
                                          Container(
                                            ...
                                            child: Icon(Icons.bar_chart_rounded, size: 20, color: palette.primaryDim),
                                          ),
                                        ],
                                      ),
                                      const SizedBox(height: 32),
                                      SizedBox(
                                        ...
                                        child: Row(
                                          ...
                                          children: List.generate(chartData.length, (index) {
                                            ...
                                            final maxValue = chartData.map((item) => item.$2).fold<double>(0.0, (a, b) => a > b ? a : b);
                                            final value = entry.$2;
                                            final barFactor = maxValue == 0 ? 0.05 : (value / maxValue).clamp(0.05, 1.0);
                                                  ...
                                                  Expanded(
                                                    child: Align(
                                                      ...
                                                      child: Container(
                                                        ...
                                                        decoration: BoxDecoration(
                                                          gradient: value > 0 ? palette.primaryGradient : null,
                                                          color: value > 0 ? null : palette.surfaceLow,
                            ...
                            Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Icon(Icons.history_rounded, size: 20, color: palette.textMuted),
                                ],
                              ),
                            ),
                            const SizedBox(height: 20),
                            ...sessions.where((s) => (s.attemptCount ?? 0) > 0).take(5).map((session) {
                              final date = session.startedAt ?? session.createdAt;
                              final dateStr = date != null ? DateFormat('MMM dd, yyyy').format(date) : 'Recent';
                                    ...
                                    child: BackdropFilter(
                                      ...
                                      child: Container(
                                        ...
                                        decoration: BoxDecoration(
                                          color: isDark 
                                              ? palette.surfaceCard.withValues(alpha: 0.6) 
                                              : palette.surfaceCard.withValues(alpha: 0.85),
                                          borderRadius: BorderRadius.circular(24),
                                          border: Border.all(
                                            color: isDark ? Colors.white.withValues(alpha: 0.05) : palette.outline.withValues(alpha: 0.5),
                                            width: 1,
                                          ),
                                        ),
                                        child: Row(
  ...
  List<(String, double)> _weeklyHourChart(List<ApiSession> items) {
    ...
    return List.generate(labels.length, (index) => (labels[index], hourCounts[index]));
  }
}
